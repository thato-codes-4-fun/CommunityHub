...
class PreviewEventWidget extends StatefulWidget {
  const PreviewEventWidget({super.key});

  @override
  State<PreviewEventWidget> createState() => _PreviewEventWidgetState();
}

class _PreviewEventWidgetState extends State<PreviewEventWidget> {
  @override
